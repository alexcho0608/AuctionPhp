...
<table style="background-color:#ff00ff;color:red;padding:3px 3px 3px 3px;margin: 100px 100px 100px 430px;" height=300 width=400>
	<tr height=20% ><td> <div style="font-size:150%;font-weight:bold;font-style:oblique;text-align:center">Не сте влезли в профила си!</div></td></tr>
	<tr height=90%>
		<td>
		<div style="align:center">
			<form method="POST" action="User.php">
            <label>Име:&nbsp&nbsp&nbsp &nbsp&nbsp <input type=text name="User"></input></label> <br>
            <label>Парола:&nbsp <input type=password name="Password"></input></label></div><br> 
